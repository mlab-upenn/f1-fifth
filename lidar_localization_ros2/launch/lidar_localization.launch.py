...
def generate_launch_description():
    ...
    lidar_tf = launch_ros.actions.Node(
        ...
        arguments=['0','0','0','0','0','0','1','base_link','laser_sensor_frame']
        )
    ...
    imu_tf = launch_ros.actions.Node(
        ...
        package='tf2_ros',
        executable='static_transform_publisher',
        arguments=['0','0','0','0','0','0.7071068','0.7071068','base_link','vesc_frame']
        )
    ...
    lidar_localization = launch_ros.actions.LifecycleNode(
        ...
        remappings=[('/cloud','/points'), ('/velodyne_points','/points')],
        output='screen')
