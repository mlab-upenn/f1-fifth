...
static const _WheelSensor_type_support_symbol_names_t _WheelSensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fixposition_driver_ros2, msg, WheelSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fixposition_driver_ros2, msg, WheelSensor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fixposition_driver_ros2, msg, WheelSensor)() {
  return &::fixposition_driver_ros2::msg::rosidl_typesupport_c::WheelSensor_message_type_support_handle;
}
