...
static const _Speed_type_support_symbol_names_t _Speed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fixposition_driver_ros2, msg, Speed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fixposition_driver_ros2, msg, Speed)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fixposition_driver_ros2, msg, Speed)() {
  return &::fixposition_driver_ros2::msg::rosidl_typesupport_c::Speed_message_type_support_handle;
}
