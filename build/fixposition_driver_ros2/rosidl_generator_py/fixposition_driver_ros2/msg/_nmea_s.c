...
bool fixposition_driver_ros2__msg__nmea__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fixposition_driver_ros2.msg._nmea.NMEA", full_classname_dest, 38) == 0);
  }
  fixposition_driver_ros2__msg__NMEA * ros_message = _ros_message;
  {  // header
...
PyObject * fixposition_driver_ros2__msg__nmea__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fixposition_driver_ros2.msg._nmea");
