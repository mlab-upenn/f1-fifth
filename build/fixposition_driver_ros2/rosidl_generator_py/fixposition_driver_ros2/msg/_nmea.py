...
class Metaclass_NMEA(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'fixposition_driver_ros2.msg.NMEA')
            logger.debug(
    ...
    def COVARIANCE_TYPE_UNKNOWN(self):
        ...
        return Metaclass_NMEA.__constants['COVARIANCE_TYPE_UNKNOWN']

    @property
    def COVARIANCE_TYPE_APPROXIMATED(self):
        """Message constant 'COVARIANCE_TYPE_APPROXIMATED'."""
        return Metaclass_NMEA.__constants['COVARIANCE_TYPE_APPROXIMATED']

    @property
    def COVARIANCE_TYPE_DIAGONAL_KNOWN(self):
        """Message constant 'COVARIANCE_TYPE_DIAGONAL_KNOWN'."""
        return Metaclass_NMEA.__constants['COVARIANCE_TYPE_DIAGONAL_KNOWN']

    @property
    def COVARIANCE_TYPE_KNOWN(self):
        """Message constant 'COVARIANCE_TYPE_KNOWN'."""
        return Metaclass_NMEA.__constants['COVARIANCE_TYPE_KNOWN']
...
class NMEA(metaclass=Metaclass_NMEA):
    ...
    def course(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'course' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._course = value
