...
#include "fixposition_driver_ros2/msg/detail/wheel_sensor__functions.h"  // sensors
  ...
  // Field name: sensors
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, fixposition_driver_ros2, msg, WheelSensor
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: sensors
  {
    ...
    if (ros_message->sensors.data) {
      fixposition_driver_ros2__msg__WheelSensor__Sequence__fini(&ros_message->sensors);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name sensors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_fixposition_driver_ros2__msg__WheelSensor(
  ...
  size_t current_alignment)
{
  ...
  // member: sensors
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_fixposition_driver_ros2__msg__WheelSensor(
