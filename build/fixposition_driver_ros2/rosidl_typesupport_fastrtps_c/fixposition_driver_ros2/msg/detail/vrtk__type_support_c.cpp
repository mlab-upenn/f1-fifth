...
#include "fixposition_driver_ros2/msg/detail/vrtk__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // kin_frame, pose_frame, version
#include "rosidl_runtime_c/string_functions.h"  // kin_frame, pose_frame, version
...
using _VRTK__ros_msg_type = fixposition_driver_ros2__msg__VRTK;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VRTK__ros_msg_type * ros_message = static_cast<const _VRTK__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: kin_frame
  {
    const rosidl_runtime_c__String * str = &ros_message->kin_frame;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  // Field name: imu_bias_status
  {
    cdr << ros_message->imu_bias_status;
  }

  // Field name: gnss1_status
  {
    cdr << ros_message->gnss1_status;
  }

  // Field name: gnss2_status
  {
    cdr << ros_message->gnss2_status;
  }

  // Field name: wheelspeed_status
  {
  ...
  void * untyped_ros_message)
{
  ...
  _VRTK__ros_msg_type * ros_message = static_cast<_VRTK__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: kin_frame
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->kin_frame.data) {
      rosidl_runtime_c__String__init(&ros_message->kin_frame);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->kin_frame,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'kin_frame'\n");
      return false;
    }
  }
...
static uint32_t _VRTK__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fixposition_driver_ros2__msg__VRTK(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fixposition_driver_ros2__msg__VRTK;
    is_plain =
      (
...
static size_t _VRTK__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fixposition_driver_ros2__msg__VRTK(
...
static message_type_support_callbacks_t __callbacks_VRTK = {
...
static rosidl_message_type_support_t _VRTK__type_support = {
