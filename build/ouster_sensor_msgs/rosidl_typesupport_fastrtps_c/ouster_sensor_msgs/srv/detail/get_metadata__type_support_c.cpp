  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ouster_sensor_msgs__srv__GetMetadata_Request;
    is_plain =
      (
...
static size_t _GetMetadata_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ouster_sensor_msgs__srv__GetMetadata_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ouster_sensor_msgs__srv__GetMetadata_Response;
    is_plain =
      (
...
static size_t _GetMetadata_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ouster_sensor_msgs__srv__GetMetadata_Response(
    full_bounded, is_plain, 0);
